                ...
                <div className="d-flex align-items-center justify-content-center" style={{ padding: "4rem 1rem 1rem 1rem" }}>
                    <div >
                        <div className="row">
                            ...
                            <div className="card" style={{ width: "18rem", boxShadow: '0 0 15px' }}>
                                <img className="card-img-top " style={{ padding: "1rem 1rem 1rem 1rem", }} src={store.student.student.student.avatar} alt="Card image cap" />
