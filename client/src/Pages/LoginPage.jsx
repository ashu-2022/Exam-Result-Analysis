...
const LoginPage = () => {
    ...
    return (
        ...
        <div className="d-flex justify-content-md-center align-items-center vh-100">
            <div className="m-auto border bg-dark" style={{ borderRadius: "1rem", boxShadow: '0 0 15px', padding: "5rem 5rem 5rem 5rem" }}>
                <h1 className="display-4 text-center text-white">ADMIN</h1>
                <form noValidate onSubmit={fromHandler}>
                    <div className="form-group text-white">
                        <label htmlFor="emailId text-white">Registration Number</label>
